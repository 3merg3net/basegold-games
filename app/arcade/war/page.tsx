    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-[#020617] to-black text-white">
      ...
      <section className="relative border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-6 md:py-8 space-y-4">
          {/* Mode switcher (Arcade / On-chain / Live) */}
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm md:text-base text-white/80 max-w-xl">
              ...
              <span className="font-semibold text-[#FFD700]">
                heads-up card battle
              </span>{' '}
              that will be one of the first live multiplayer tables on Base. BGRC chips
              let you play instantly while we finalize the on-chain cashier connection.
            </p>

            {/* Global arcade HUD (includes shared chip balance bar) */}
            <ArcadeWalletHUD />
          </div>
          ...
          <div className="mt-4 space-y-4 text-[11px] sm:text-xs md:text-sm text-white/70">
            <div>
              ...
              <p className="mt-1">
                ...
                <strong>War!</strong> — both sides burn a card and pull again. Simple,
                fast, and perfect for arcade-speed action before the real money tables
                open.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1">
                One of the first games going live in the Base Gold Rush card room.
                Real-time matchmaking, table chat, and on-chain settlement will make
                War one of the most viral live games in the entire ecosystem.
              </p>
            </div>
          </div>
        </div>
