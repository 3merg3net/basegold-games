    ...
    <div className="rounded-2xl p-4 bg-black/40 border border-white/10">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="text-white/80">
          <div className="text-xs">BGLD Balance</div>
          <div className="font-black text-white tabular-nums">{balance.toLocaleString()} BGLD</div>
        </div>
      ...
      <div className="text-[11px] text-white/50 mt-2">
        Tip: Click a quick bet to set the wager. Make sure you’ve approved enough BGLD before playing.
      </div>
    </div>
  )
}
